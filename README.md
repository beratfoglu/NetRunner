  ...
  **V AI Handler** — Groq API:
  ...
  - Privacy Cloak uses StyleGAN2 (thispersondoesnotexist.com) which may be detectable by advanced AI detection tools via frequency analysis and GAN-specific artifacts; a diffusion model (SDXL) would provide stronger evasion but requires a paid API 
